                ...
                data.map(post => {
                    return (
                        <div key={post._id} className="card  mb-3" style={{ maxWidth: "18rem", margin: "50px auto" }}>
                            <h6 className="card-header bg-transparent" style={{ borderBottom: "none", padding: "5px", color: "black" }}><Link style={{ textDecoration: "none", color: "black" }} to={post.postedBy._id !== state._id?"/profile/"+post.postedBy._id :"/profile"  }><img style={{height:"40px",height:"40px",borderRadius:"20px"}} src={post.postedBy.pic} /> {post.postedBy.name}</Link> { post.postedBy._id == state._id 
                            ...
                            <div className="card-footer bg-transparent" style={{ borderTop: "none", paddingLeft: "5px" }}>
                                ...
                                <form onSubmit={(e) => {
                                        ...
                                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                                            <i style={{ marginTop: "11px", paddingLeft: "5px" }} className="fa-regular fa-comment"></i><input style={{ border: "none" }} type="text" className="form-control" id="comment" name="comment" placeholder="Add a comment..." onChange={(e) => {
